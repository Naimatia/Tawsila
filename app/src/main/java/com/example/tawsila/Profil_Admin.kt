...
// Replace the placeholder "getUserInfo" with your actual API endpoint
        ...
        getUserInfoCall.enqueue(object : Callback<UserDTO> {
            override fun onResponse(call: Call<UserDTO>, response: Response<UserDTO>) {
                if (response.isSuccessful) {
                    ...
                    if (profileImage != null) {
                        when (profileImage) {
                            ...
                            is String -> {
                                ...
                                val decodedBytes =
                                    Base64.decode(profileImage as String, Base64.DEFAULT)
                                val bitmap = BitmapFactory.decodeByteArray(
                                    decodedBytes,
                                    0,
                                    decodedBytes.size
                    ...
                    Log.e(
                        "YourTag",
                        "Failed to retrieve user information. Code: ${response.code()}"
                    )
    ...
    private fun setUpBottomNavigationView() {
        ...
        bottomNavigationView.selectedItemId = R.id.profile_image
